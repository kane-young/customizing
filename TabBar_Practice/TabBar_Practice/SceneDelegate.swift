...
//                    tbItem.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14)], for: .normal)
                }
                
                let tbItemProxy = UITabBarItem.appearance()
                //외형 프록시 객체를 이용하여 아이템의 타이틀 색상과 폰트 크기를 설정합니다.
                ...
                tbProxy.selectionIndicatorTintColor = .white
...
//                UITabBar.appearance()//탭 바의 외형 프록시 객체
            }
        }
